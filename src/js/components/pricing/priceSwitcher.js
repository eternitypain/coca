export const usePriceSwitcher = () => {
    ...
    const numEnterprisePrice = enterprisePrice.textContent.replace(
        /[^0-9.]/g,
        '',
    );
    ...
    const starterNoneDiscountedPrice =
        calculateDiscountedPrice(numStarterPrice);
    const popularNoneDiscountedPrice =
        calculateDiscountedPrice(numPopularPrice);
    const enterpriseNoneDiscountedPrice =
        calculateDiscountedPrice(numEnterprisePrice);
